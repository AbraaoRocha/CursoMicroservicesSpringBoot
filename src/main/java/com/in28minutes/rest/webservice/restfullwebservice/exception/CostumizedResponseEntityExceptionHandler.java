...
import com.in28minutes.rest.webservice.restfullwebservice.user.UserNotFoundException;
...
public class CostumizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), "Validation Falied",
